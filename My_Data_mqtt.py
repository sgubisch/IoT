...
DEFAULT_MQTT_BROKER_IP = "test.mosquitto.org"
...
def read_pms5003(pms5003):
    ...
    try:
        ...
        values["pm1 (Ultrafine particles)"] = pm_values.pm_ug_per_m3(1)
        values["pm25 (Combustion particles, organic compounds, metals)"] = pm_values.pm_ug_per_m3(2.5)
        values["pm10 (Dust, pollen, mould spores)"] = pm_values.pm_ug_per_m3(10)
