...
DEFAULT_MQTT_BROKER_IP = "172.18.0.2"
DEFAULT_MQTT_BROKER_PORT = 1883
DEFAULT_MQTT_TOPIC = "enviroplus_507"
...
def read_pms5003(pms5003):
    ...
    try:
        ...
        values["pm.3 (Ultrafine particles)"] = pm_values.pm_per_1l_air(0.3)
        values["pm0.5 (Combustion particles, organic compounds, metals)"] = pm_values.pm_per_1l_air(0.5)
        values["pm1.0 (Dust, pollen, mould spores)"] = pm_values.pm_per_1l_air(1.0)
